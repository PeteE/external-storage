...
var startcontrollerCmd = &cobra.Command{
    ...
    Run: func(cmd *cobra.Command, args []string) {
        ...
        iqn := viper.GetString("freenas-iqn")
        ...
        freeNasConfig := &provisioner.FreeNasConfig{
            ...
            Portal: fmt.Sprintf("%s:%d", viper.GetString("freenas-address"), 3260),
            IQN: iqn,
        }
...
func init() {
	...
	startcontrollerCmd.Flags().String("pool-name", "wheatpool", "name of the freenas zpool")
